...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-15 left-5 z-50 inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] shadow-lg hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-white/60"
    >
