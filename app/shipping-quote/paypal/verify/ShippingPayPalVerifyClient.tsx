...
export default function ShippingPayPalVerifyClient() {
  ...
  useEffect(() => {
    ...
    async function verify() {
      ...
      const res = await fetch("/api/shipping-quote/paypal/verify", {
        method: "POST",
      ...
      setStatus("success");
      setMessage("Payment verified. Redirecting to your shipping quote…");
          ...
          {status === "error" ? (
            <div className="mt-6 rounded-2xl border border-red-200 bg-red-50 p-4 text-sm text-red-700">
              ...
              <div className="mt-4 flex flex-col gap-2">
                ...
                <button type="button" onClick={() => router.replace("/shipments")} className="btn btn-ghost">
                  Back to shipments
                </button>
              </div>
            </div>
