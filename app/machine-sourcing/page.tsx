...
<a
  ...
  className="inline-flex items-center justify-center rounded-xl bg-white px-3 py-2 text-sm font-semibold text-neutral-950 hover:bg-neutral-200 sm:hidden"
>
  <svg viewBox="0 0 32 32" className="h-5 w-5 fill-neutral-950" aria-hidden="true">
...
{/* Desktop and up: normal Start chat button */}
<Link
  href="/machine-sourcing"
  className="hidden items-center justify-center rounded-xl bg-white px-3 py-2 text-sm font-semibold text-neutral-950 hover:bg-neutral-200 sm:inline-flex"
>
  Start chat
</Link>
    </div>
